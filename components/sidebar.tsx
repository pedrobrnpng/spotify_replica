...
function Sidebar() {
  ...
  return (
    <div className="md:text-md hidden h-screen flex-col overflow-y-scroll border-r border-gray-900 p-5 text-xs text-gray-500 scrollbar-hide sm:max-w-[12rem] md:inline-flex lg:max-w-[15rem] lg:text-sm">
